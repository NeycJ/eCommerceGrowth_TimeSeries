...
## The pattern shows daily search increase from a range of 8am - 10am, then search trends decline from the range of 10pm - midnight.
...
## Yes, search traffic increased during the month that Mercado Libre released its financial results.
...
## Sunday the last hour within the day, through Monday the first hour of the day.

3. Group the search data by the week of the year. Does the search traffic tend to increase during the winter holiday period (weeks 40 through 52)?
## Yes the search starts to increase weeks 43-51
...
## Both time series share the big drop in March 2020 and the big jump 5/5/2020. I would agree that both time series are consistent with sharing the same narrative.
...
## Lagged Search Traffic and Stock Volatility has a very low to almost no correlation. Lagged Search and Stock Return has an extremely weak, but positive correlation since the correlation is above 0.
...
2. After estimating the model, plot the forecast. What is the near-term forecast for the popularity of Mercado Libre?
   ## Near-term forecast shows MercadoLibre popularity will decrease.
...
3. Plot the individual time series components of the model to answer the following questions:
   ...
   ## Tuesday receives the most search traffic.
...
3. Produce a sales forecast for the finance group. Give them a number for the expected total sales in the next quarter. Include the best- and worst-case scenarios to help them make better plans.
  ## Best Case      1051.389082
  ## Worst Case      887.436371
  ## Most Likely     969.637262
